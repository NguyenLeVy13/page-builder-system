...
// Custom query
RoleMenuSchema.query.sortable = function (req) {
	const isSort =
...
RoleMenuSchema.query.searchable = function (req) {
	const isSearch =
...
RoleMenuSchema.query.limitable = function (req) {
...
module.exports = mongoose.model("role_menus", RoleMenuSchema);
